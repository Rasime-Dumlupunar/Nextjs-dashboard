...
"[project]/app/(pages)/products/DeleteButton.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DeleteButton = ({ id })=>{
    ...
    const handleDelete = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteProduct"])(id).then(()=>{
            // sayfayı yenile (ürünler tekrar alınsın)
            router.refresh();
            //bildirim gönder
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Ürün kaldırıldı!!");
        });
    };
...
"[project]/app/(pages)/products/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=app_%28pages%29_products_006f5b._.js.map